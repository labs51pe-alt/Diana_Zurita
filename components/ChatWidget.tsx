...
const quickOptions = [
  { label: '📍 ¿Vas a domicilio?', answer: '¡Sí! Llevo todo el estudio a tu casa. Ten en cuenta que la movilidad es un costo aparte y está sujeto al distrito y distancia.' },
  { label: '💄 ¿Qué marcas usas?', answer: 'Solo alta gama: MAC, Huda Beauty, Fenty, NARS. Hipoalergénico y full HD para fotos increíbles.' },
  { label: '💰 Precios', answer: 'El Maquillaje Express inicia desde S/35. El resto varía según el estilo. Recuerda que la movilidad es un costo adicional variable.' },
